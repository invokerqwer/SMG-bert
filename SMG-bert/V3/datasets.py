...
class Pretrain_Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return  raw_lth,dist_i,dist_j,atom_id_list_mask,atom_id_list_raw,masked_flag,adjoin_matrix_G,gnn_adj_G,dist_matrix_G,angle_i.long(),angle_j.long(),angle_k.long(),angle,torsion_k.long(),torsion_i.long(),torsion_j.long(),torsion_t.long(),torsion
    @staticmethod
    ...
    @staticmethod
    def collate_fn(batch: List[Any],pos_data=True,gnn_adj=True,dist_data=True,angle_data=True,torsion_data = True):
...
def get_pretrain_dataloader(config,logger,smiles_data_path,dist_data_path,angle_data_path,torsion_data_path):
    ...
    dataset = Pretrain_Dataset(smiles_data,dist_data=dist_data,gnn_adj=True,torsion_data=torsion_data,angle_data=angle_data)
    ...
    test_dataloader = DataLoader(test_dataset, batch_size=config.train.batch_size,
                                 collate_fn=collate_fn, num_workers=config.train.num_workers,pin_memory=config.dataset.pin_memory)
