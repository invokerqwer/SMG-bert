...
class Downstream_Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        atom_symbol_list, adjoin_matrix,l1,l2 = Smiles_to_adjoin(smiles, explicit_hydrogens=True,size=self.mol_fix_len - 1)
        ...
        return  atom_id_list_mask,masked_flag,raw_lth,dist_i,dist_j,atom_id_list_raw,adjoin_matrix_G,\
                gnn_adj_G,dist_matrix_G,angle_i,angle_j,angle_k,angle,torsion_k,torsion_i,torsion_j,torsion_t,torsion,label,smiles,l1,l2
    @staticmethod
    ...
    def collate_fn(self,batch: List[Any]):
        atom_id_list_mask,masked_flag,raw_lth,dist_i,dist_j,atom_id_list_raw,adjoin_matrix_G,gnn_adj_G,dist_matrix_G,angle_i,angle_j,angle_k,angle,torsion_k,torsion_i,torsion_j,torsion_t,torsion,label,smiles,l1,l2 = tuple(zip(*batch))
